...
First Transfer: gasUsed: 85,945
\item L1 gas costs: execute:

execute after the change: first trade: gasUsed: 133,518
 before and after (1 trade, 2 trades, 3 trades) (functions that run that got modified) (difference of two mappings)
